...
export const userServices = {
    ...
    updateUser: async (userData) => {
        try {
            const response = await axiosInstance.put(`${BASE_URL}/me/update`, userData);
            return {
                success: true,
                data: response.data,
                message: response.data.message,
    ...
    changePassword: async (passwordData) => {
        try {
            const response = await axiosInstance.put(`${BASE_URL}/me/change-password`, passwordData);
            return {
                success: true,
                data: response.data,
                message: response.data.message,
    ...
    updateLocation: async (locationData) => {
        try {
            const response = await axiosInstance.put(`${BASE_URL}/me/update-location`, locationData);
            return {
                success: true,
                data: response.data,
                message: response.data.message,
    ...
    changeProfilePhoto: async (photo) => {
        try {
            const response = await axiosInstance.put(`${BASE_URL}/me/update-profile-photo`, photo, { headers: { "Content-Type": "multipart/form-data" } });
            return {
                success: true,
                data: response.data,
                message: response.data.message,
    ...
    worker: async (workerId) => {
        try {
            const response = await axiosInstance.get(`${BASE_URL}/worker/${workerId}`);
            return {
                success: true,
                data: response.data,
                message: response.data.message,
